...
namespace RequestTimeOff.Specflow.Features.Models.Requests
{
    ...
    public partial class ValidateAddFeature : object, Xunit.IClassFixture<ValidateAddFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "ValidateAdd.feature"
#line hidden
        
        public ValidateAddFeature(ValidateAddFeature.FixtureData fixtureData, RequestTimeOff_Specflow_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Models/Requests", "ValidateAdd", "A user that adds a request off record is only allowed to add requests that are va" +
        ...
        [Xunit.TraitAttribute("FeatureTitle", "ValidateAdd")]
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                ValidateAddFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                ValidateAddFeature.FeatureTearDown();
            }
        }
    }
}
