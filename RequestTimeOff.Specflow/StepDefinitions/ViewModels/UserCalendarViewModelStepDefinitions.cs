...
namespace RequestTimeOff.Specflow.StepDefinitions.ViewModels
{
    ...
    public class UserCalendarViewModelStepDefinitions
    {
        ...
        public UserCalendarViewModelStepDefinitions()
        {
            var user = new User();
            _session.User = user;
            _calendarViewModel = new UserCalendarViewModel(_requestTimeOffRepository, _session);
        }
        [Given(@"The current date on the usercalendar view model is (.*)st July (.*)")]
        public void GivenTheCurrentDateOnTheUsercalendarViewModelIsStJuly(int day, int year)
        {
            _calendarViewModel.Month = 7;
            _calendarViewModel.Year = year;
        }

        [Given(@"the holidays are loaded usercalendar view model")]
        public void GivenTheHolidaysAreLoadedUsercalendarViewModel()
        {
        ...
        [Given(@"the time offs are loaded usercalendar view model")]
        public void GivenTheTimeOffsAreLoadedUsercalendarViewModel()
        {
        ...
        public void ThenCorrectDataWillBeLoadedIntoTheCalendarCollectionsUsercalendarViewModel()
        {
        ...
        [Given(@"The current date on the usercalendar is (.*)st July (.*) usercalendar view model")]
        public void GivenTheCurrentDateOnTheUsercalendarIsStJulyUsercalendarViewModel(int day, int year)
        {
            _calendarViewModel.Month = 7;
            _calendarViewModel.Year = year;
        }
        ...
        public void ThenCorrectDataWillBeLoadedIntoTheCalendarCollectionsWithNoHolidaysUsercalendarViewModel()
        {
            _calendarViewModel.Dates[0].Should().BeNull();
            _calendarViewModel.Dates[1].Should().BeNull();
            _calendarViewModel.Dates[2].Should().BeNull();
